...
# ]
# ///
"""Product Verification — product authentication certificate on Cardano preprod."""
...
cert = CertificateData(hash=data_hash, algorithm="SHA-256", metadata=json.dumps(metadata))
...
try:
    ...
    print(f"  {_config["verify_url"]}/{data_hash}")
